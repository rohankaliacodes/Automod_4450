...
export const Home = () => {
  ...
  const handleCategoryClick = (category) => console.log(`Category Selected: ${category}`);
  const handleAiSubmit = () => console.log(`AI Mechanic Input: ${aiInput}`);

  return (
    <>
      {/* Header should be outside the scrollable container */}
      <Header />
